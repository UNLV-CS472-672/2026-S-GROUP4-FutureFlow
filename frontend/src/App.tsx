...
import ExploreDegreePage from './pages/ExploreDegreePage';
import DegreeDetailsPage from './pages/DegreeDetailsPage';
    ...
    >
      <Router>
        <Routes>
          ...
          />
          <Route
            path="/explore-degrees"
            element={user ? <ExploreDegreePage /> : <Navigate to="/" />}
          />
          <Route
            path="/job-center"
          ...
          />
          <Route
            path="/degrees/:id/plan"
            element={user ? <DegreePlanPage /> : <Navigate to="/" />}
          />
          <Route
            path="/degrees/:id"
            element={user ? <DegreeDetailsPage /> : <Navigate to="/" />}
          />
          <Route
            path="/degree-search"
